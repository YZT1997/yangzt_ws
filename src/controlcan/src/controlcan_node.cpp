...
int main(int argc, char **argv)
{
	...
	send[0].Data[0] = 0x01;
	send[0].Data[1] = 0x11;     // 功能码
	send[0].Data[2] = 0x09;     // 寄存器地址
	send[0].Data[3] = 0x00;     // 寄存器高字节
	send[0].Data[4] = 0x00;     // 寄存器低字节
	send[0].Data[5] = 0x00;     // 备用
	send[0].Data[6] = 0x00;     // 备用
	send[0].Data[7] = 0x1c;     // 异或校验
	...
	while(times--)
	{
	    if(VCI_Transmit(VCI_USBCAN2,0,0,send,1) == 1)
		{
			...
			printf("CAN1 TX ID:0x%04X",send[0].ID);
