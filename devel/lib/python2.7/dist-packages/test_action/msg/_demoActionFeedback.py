...
"""autogenerated by genpy from test_action/demoActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class demoActionFeedback(genpy.Message):
  ...
  _type = "test_action/demoActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','test_action/demoFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = test_action.msg.demoFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = test_action.msg.demoFeedback()
