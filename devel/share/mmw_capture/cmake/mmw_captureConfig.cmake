...
if("TRUE" STREQUAL "TRUE")
  set(mmw_capture_SOURCE_PREFIX /home/yangzt/yangzt_ws/src/mmw_capture)
  set(mmw_capture_DEVEL_PREFIX /home/yangzt/yangzt_ws/devel)
  ...
  set(mmw_capture_INSTALL_PREFIX /home/yangzt/yangzt_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mmw_capture' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yangzt/yangzt_ws/src/mmw_capture/${idir}'.  ${_report}")
    endif()
